...
while True:
    ...
    s_white.f = -uk*s_white.mass*g*norm(s_white.v)
    s_red.f = -uk*s_red.mass*g*norm(s_red.v)
    s_green.f = -uk*s_green.mass*g*norm(s_green.v)

    s_white.v += s_white.f/s_white.mass*dt
    s_red.v += s_red.f/s_red.mass*dt
    s_green.v += s_green.f/s_green.mass*dt
